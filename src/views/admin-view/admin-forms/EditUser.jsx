...
const EditUser = () => {
    ...
    const {data, isSuccess: dataIsSuccess} = getUserById(id);
    ...
    useEffect(() => {
        if (dataIsSuccess && data) {
            ...
            formik.setFieldValue("type", data.data.data.type)
            formik.setFieldValue("phonenumber", data.data.data.phonenumber)
